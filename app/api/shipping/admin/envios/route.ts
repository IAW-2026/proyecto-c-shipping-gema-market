...
import { getAdminShipments } from "@/lib/db/queries/admin/shipments";
import { AdminShipmentsQuerySchema } from "@/lib/schemas/api/admin";

export async function GET(request: NextRequest) {
    const start = Date.now();
    const endpoint = "GET /api/shipping/admin/envios";
    ...
    try {
        ...
        const parsed = AdminShipmentsQuerySchema.safeParse(rawParams);
        ...
        console.error("[ADMIN_ENVIOS] Error:", error);
