...
const SECTIONS: ChecklistSection[] = [
    {
        ...
        icon: Repeat,
        items: [
            { id: "fc-1", label: "Ir a Available y tomar un envio waiting_for_courier" },
            { id: "fc-2", label: "Ir a Courier - Click \"Recoger paquete\"" },
            { id: "fc-3", label: "Ir a Courier - Click \"Iniciar viaje\"" },
            { id: "fc-4", label: "Ir a Courier - Click \"Marcar entregado\"" },
            { id: "fc-5", label: "Ver en History que el envio aparece" },
            { id: "fc-6", label: "Ver en Settlements la liquidacion semanal" },
    ...
    },
    {
        ...
        items: [
            ...
            { id: "fs-2", label: "Editar precio de un envio waiting_for_courier" },
            { id: "fs-3", label: "Desafectar un envio pending_pickup" },
